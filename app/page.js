      ...
      <div className="max-w-6xl mx-auto">
        ...
        {gameState === 'DRAFT' && (
          ...
          <div>
            ...
            {/* Slotlar: Mobilde grid-cols-2, Masaüstünde grid-cols-5 */}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        {draftOptions[type].map((item) => (
                          ...
                          <button key={item.id} onClick={() => handleSelectCard(type, item)}
                            ...
                            <span className="text-[10px] bg-gray-800 px-2 py-1 rounded">{item.tier}</span>
            ...
            <div className="bg-gray-900 border border-gray-800 p-6 rounded-2xl">
              ...
              <div className="space-y-2 text-sm">
                ...
                {Object.entries(playerSelection).map(([key, val]) => (
                  ...
                  <p key={key}><span className="text-gray-500 block text-[10px] uppercase">{LABELS[key]}</span> {val.name || val.team}</p>
        ...
        {/* Oyun Sonu ekranlarını benzer şekilde korudum... */}
